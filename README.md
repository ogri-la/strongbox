...
1. download: [./releases/strongbox](https://github.com/ogri-la/strongbox/releases/download/4.4.0/strongbox)
...
1. download: [./releases/strongbox-4.4.0-standalone.jar](https://github.com/ogri-la/strongbox/releases/download/4.4.0/strongbox-4.4.0-standalone.jar)
2. run: `java -jar strongbox-4.4.0-standalone.jar`
