...
1. download: [./releases/strongbox](https://github.com/ogri-la/strongbox/releases/download/5.3.0/strongbox)
...
1. download: [./releases/strongbox-5.3.0-standalone.jar](https://github.com/ogri-la/strongbox/releases/download/5.3.0/strongbox-5.3.0-standalone.jar)
2. run: `java -jar strongbox-5.3.0-standalone.jar`
