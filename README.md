...
1. download: [./releases/strongbox](https://github.com/ogri-la/strongbox/releases/download/3.1.0/strongbox)
2. make executable: `chmod +x strongbox`
3. run: `./strongbox`

If you're on macOS or just prefer Java `.jar` files (requires Java 11+):

1. download: [./releases/strongbox-3.1.0-standalone.jar](https://github.com/ogri-la/strongbox/releases/download/3.1.0/strongbox-3.1.0-standalone.jar)
2. run: `java -jar strongbox-3.1.0-standalone.jar`
